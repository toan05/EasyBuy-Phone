    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> ViewProductDetails(int productId)
        {
            try
            {
                ...
                var userIdClaim = User.FindFirst(System.Security.Claims.ClaimTypes.NameIdentifier); // Lấy claim
                int? userId = userIdClaim != null && int.TryParse(userIdClaim.Value, out int id) ? id : null; // Chuyển thành int?
