...
namespace EasyBuy.Areas.Admin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            // Nếu đã đăng nhập với scheme "AdminCookie", chuyển đến dashboard
            if (User.Identity.IsAuthenticated && User.Identity.AuthenticationType == "AdminScheme" && (User.IsInRole("Admin") || User.IsInRole("NVKD") || User.IsInRole("NVKho")))
            {
